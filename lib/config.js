var administrador=require('./administrador_functions');var mysql=require('mysql');var mysqlPort=3306;var mysqlHost;var mysqlUser;var mysqlPass;if(IS_DESARROLLO){mysqlHost='167.99.191.140';mysqlUser='bancodtuser';mysqlPass='fq9!4R!G6feHJ^8x';}else{if(ID_APP===ID_APP_CLIPP){mysqlHost='10.73.211.219';mysqlUser='ServerMaster';mysqlPass='Ahg%14!jkhGh7Ha7*(7agiG&*A^*&tgG*A&Tyuf';}else{throw"ERROR NO SE SELECCIONO UNA BASE DE DATOS POR APP CONFIG";}}
