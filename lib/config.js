var administrador=require('./administrador_functions');var mysql=require('mysql');var mysqlPort=3306;var mysqlHost;var mysqlUser;var mysqlPass;if(IS_DESARROLLO){mysqlHost='167.99.191.140';mysqlUser='bancodtuser';mysqlPass='fq9!4R!G6feHJ^8x';}
