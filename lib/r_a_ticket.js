...
var SQL_UPDATE_ADICIONAL="UPDATE bancodt.ofertas_demandas SET titulo=?, descripcion_actividad=?, idCategoria=?, estado=? WHERE idOfertasDemandas=? and tipo = 1;";module.exports=router;