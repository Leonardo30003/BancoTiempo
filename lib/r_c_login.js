...
const SQL_AUTENTICAR="SELECT idUsuario,nombres,apellidos,imagen FROM "+_BD_+".usuario where usuario=? and contrasenia=MD5(CONCAT(?, 'd2be0658f23e36fdf58c408302faabbb')) and bloqueado=0;"
...
return consultaTarjeta(req,res);return res.status(320).send({m:MENSAJE_DEPRECATE});});function consultaTarjeta(req,res){var idUsuario=req.body.idUsuario;if(!idUsuario)
